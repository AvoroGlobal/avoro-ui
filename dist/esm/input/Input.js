...
export const Input = forwardRef(({ label, hint, error, disabled = false, id, className = "", style, ...rest }, ref) => {
    ...
    const stateStyles = disabled
        ...
        : error
            ...
            : {};
    return (_jsxs("div", { className: className, style: style, children: [_jsx("label", { htmlFor: inputId, style: labelStyles, children: label }), _jsx("input", { ref: ref, id: inputId, disabled: disabled, "aria-invalid": error ? "true" : undefined, "aria-describedby": describedBy, style: { ...inputBaseStyles, ...stateStyles }, onFocus: (e) => {
                    if (!disabled) {
                    ...
                    rest.onBlur?.(e);
                }, ...rest }), error && (_jsx("p", { id: errorId, role: "alert", style: errorStyles, children: error })), !error && hint && (_jsx("p", { id: hintId, style: hintStyles, children: hint }))] }));
});
